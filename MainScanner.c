...
/* External objects */
extern jamesr_intg line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
jamesr_void printScannerError(jamesr_string fmt, ...);
jamesr_void displayScanner(BufferPointer ptrBuffer);
jamesr_long getScannerFilesize(jamesr_string fname);
