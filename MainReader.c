 ...
 * -------------------------------------------------------------
 */
jamesr_void bErrorPrint(jamesr_string fmt, ...);
jamesr_void displayBuffer(Buffer* ptr_Buffer);
jamesr_long getFileSize(jamesr_string fname);
jamesr_intg isNumber(const jamesr_string ns);
jamesr_void startReader(jamesr_string, jamesr_string, jamesr_char, jamesr_intg, jamesr_intg);
...
jamesr_intg mainReader(jamesr_intg argc, jamesr_string* argv) {
	...
	jamesr_string program = argv[0];
	jamesr_string input = argv[2];
	jamesr_char mode = MODE_FIXED;
	jamesr_intg size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
jamesr_void startReader(jamesr_string program, jamesr_string input, jamesr_char mode, jamesr_intg size, jamesr_intg increment) {

	BufferPointer bufferp;		/* pointer to Buffer structure */
	FILE* fileHandler;			/* input file handle */
	jamesr_intg loadSize = 0;		/* the size of the file loaded in the buffer */
	jamesr_char symbol;			/* symbol read from input file */
